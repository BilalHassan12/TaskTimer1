...
public class MainActivity extends AppCompatActivity implements CursorRecyclerViewAdapter.OnTaskClickListener,
 ...
 setContentView(R.layout.activity_main);//Runtime error in this line#32
        ...
        // We need references to the container, so we can show or hide them as necessary.
    ...
    public void onSaveClicked() {
        ...
        if (!mTwoPane){
            ...
            // and make sure that the MainActivityFragment is visible.
            mainFragment.setVisibility(View.VISIBLE);
        }
    }
